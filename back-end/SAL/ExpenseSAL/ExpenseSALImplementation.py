...
class ExpenseSALImplementation(ExpenseSALInterface):
    ...
    def update_expense(self, expense: Expense) -> Expense:
        ...
        if current_info is not None and current_info.category_id == expense.category_id and current_info.date == expense.date and current_info.description == expense.description and current_info.amount == expense.amount and current_info.expense_id == expense.expense_id:
