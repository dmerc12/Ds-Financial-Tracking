...
class RegisterTests(LiveServerTestCase):
    ...
    def test_register_feature_empty_username(self):
        ...
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
    ...
    def test_register_feature_empty_phone_number(self):
        ...
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
        self.driver.find_element(By.ID, 'registerButton').click()
        self.assertEqual(self.driver.title, 'Registering')
    ...
    def test_register_feature_empty_password(self):
        ...
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
        self.driver.find_element(By.ID, 'registerButton').click()
        self.assertEqual(self.driver.title, 'Registering')
    ...
    def test_register_feature_empty_confirm_password(self):
        ...
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('')
        self.driver.find_element(By.ID, 'registerButton').click()
        self.assertEqual(self.driver.title, 'Registering')

    ## Test register feature with username too long
    def test_register_feature_username_too_long(self):
        self.driver.get(self.live_server_url)
        self.driver.find_element(By.ID, 'loginLink').click()
        self.driver.find_element(By.ID, 'username').send_keys('t' * 150)
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
    ...
    ## Test register feature with first name too long
    def test_register_feature_first_name_too_long(self):
        self.driver.get(self.live_server_url)
        self.driver.find_element(By.ID, 'loginLink').click()
        self.driver.find_element(By.ID, 'username').send_keys('test')
        self.driver.find_element(By.ID, 'first_name').send_keys('t' * 101)
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
    ...
    ## Test register feature with last name too long
    def test_register_feature_last_name_too_long(self):
        self.driver.get(self.live_server_url)
        self.driver.find_element(By.ID, 'loginLink').click()
        self.driver.find_element(By.ID, 'username').send_keys('test')
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('t' * 101)
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
    ...
    def test_register_feature_email_too_long(self):
        ...
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys(('test' * 150) + '@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
        self.driver.find_element(By.ID, 'registerButton').click()
    ...
    ## Test register feature with phone number too long
    def test_register_feature_phone_number_too_long(self):
        self.driver.get(self.live_server_url)
        self.driver.find_element(By.ID, 'loginLink').click()
        self.driver.find_element(By.ID, 'username').send_keys('test')
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1' * 21)
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
        self.driver.find_element(By.ID, 'registerButton').click()
        self.assertEqual(self.driver.title, 'Registering')
    ...
    def test_register_feature_incorrectly_formatted_email(self):
        ...
        self.driver.find_element(By.ID, 'first_name').send_keys('first')
        self.driver.find_element(By.ID, 'last_name').send_keys('last')
        self.driver.find_element(By.ID, 'email').send_keys('testatemail.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('pass12345')
        self.driver.find_element(By.ID, 'password2').send_keys('pass12345')
        self.driver.find_element(By.ID, 'registerButton').click()
    ...
    def test_register_feature_mismatching_passwords(self):
        ...
        self.driver.find_element(By.ID, 'email').send_keys('test@email.com')
        self.driver.find_element(By.ID, 'phone_number').send_keys('1-222-333-4444')
        self.driver.find_element(By.ID, 'password1').send_keys('mismatching')
        self.driver.find_element(By.ID, 'password2').send_keys('passwords')
        self.driver.find_element(By.ID, 'registerButton').click()
        self.assertEqual(self.driver.title, 'Registering')
