...
class EditDepositTests(LiveServerTestCase):
    ...
    def test_edit_deposit_feature_empty_category(self):
        ...
        self.driver.find_element(By.ID, 'deposit-4').click()
        ...
        self.driver.find_element(By.NAME, 'description').send_keys('updated')
        self.driver.find_element(By.NAME, 'amount').clear()
        self.driver.find_element(By.NAME, 'amount').send_keys(78.56)
        self.driver.find_element(By.ID, 'updateDepositButton').click()
        self.assertEqual(self.driver.title, 'Updating Deposit')
    ...
    def test_edit_deposit_feature_empty_date(self):
        ...
        self.driver.find_element(By.NAME, 'amount').send_keys(45.62)
        self.driver.find_element(By.ID, 'createDepositButton').click()
        self.driver.find_element(By.ID, 'deposit-5').click()
        self.driver.find_element(By.ID, 'updateDepositLink').click()
        category_dropdown = self.driver.find_element(By.NAME, 'category')
        category_select = Select(category_dropdown)
        category_select.select_by_index(1)
    ...
    def test_edit_deposit_feature_empty_description(self):
        ...
        self.driver.find_element(By.NAME, 'amount').send_keys(45.62)
        self.driver.find_element(By.ID, 'createDepositButton').click()
        self.driver.find_element(By.ID, 'deposit-6').click()
        self.driver.find_element(By.ID, 'updateDepositLink').click()
        category_dropdown = self.driver.find_element(By.NAME, 'category')
        category_select = Select(category_dropdown)
        category_select.select_by_index(1)
    ...
    def test_edit_deposit_feature_empty_amount(self):
        ...
        self.driver.find_element(By.NAME, 'amount').send_keys(45.62)
        self.driver.find_element(By.ID, 'createDepositButton').click()
        self.driver.find_element(By.ID, 'deposit-3').click()
        self.driver.find_element(By.ID, 'updateDepositLink').click()
        category_dropdown = self.driver.find_element(By.NAME, 'category')
        category_select = Select(category_dropdown)
        category_select.select_by_index(1)
    ...
    def test_edit_deposit_feature_negative_amount(self):
        ...
        self.driver.find_element(By.NAME, 'amount').send_keys(45.62)
        self.driver.find_element(By.ID, 'createDepositButton').click()
        self.driver.find_element(By.ID, 'deposit-7').click()
        self.driver.find_element(By.ID, 'updateDepositLink').click()
        category_dropdown = self.driver.find_element(By.NAME, 'category')
        category_select = Select(category_dropdown)
        category_select.select_by_index(1)
    ...
    def test_edit_deposit_feature_success(self):
        ...
        self.driver.find_element(By.NAME, 'amount').send_keys(45.62)
        self.driver.find_element(By.ID, 'createDepositButton').click()
        self.driver.find_element(By.ID, 'deposit-8').click()
        self.driver.find_element(By.ID, 'updateDepositLink').click()
        category_dropdown = self.driver.find_element(By.NAME, 'category')
        category_select = Select(category_dropdown)
        category_select.select_by_index(1)
